...
import React from "react";
import "./Home.css";
// It's recommended to place images in the public folder or a dedicated assets folder
import bgImage from "./WhatsApp_Image_2025-05-22_at_12.21.38_AM.jpeg"; 
    ...
    <div className="home-container">
      ...
      >
        <div className="hero-overlay">
          <div className="hero-content">
            <h1 className="hero-title">SKILL-LINK</h1>
            <p className="hero-subtitle">The Freelancer Skill Exchange Platform</p>
            <div className="hero-buttons">
      ...
      <main className="features-section">
        <h2 className="section-title">Why Choose Skill-Link?</h2>
        <div className="features-grid">
          {features.map((feature, idx) => (
            <div className="feature-card" key={idx}>
      ...
      <footer className="footer">
        <div className="footer-content">
          <div className="footer-section">
            <h3 className="footer-heading">About Skill-Link</h3>
            <p>A platform connecting freelancers for skill exchange, collaboration, and growth.</p>
          </div>
          <div className="footer-section">
